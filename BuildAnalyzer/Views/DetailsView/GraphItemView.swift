    ...
    var body: some View {
        VStack {
            ScrollView{
                ...
                GraphItemDetailsSetView(title: "Inputs", items: item?.inputs, selection: $selection, focus: $focus)
                GraphItemDetailsSetView(title: "Outputs", items: item?.outputs, selection: $selection, focus: $focus)
